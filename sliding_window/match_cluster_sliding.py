...
def contour_finding(gray_image,item_roi):
    ...
    for root, dirs, files in os.walk(test_path):
        ...
        if item.endswith(".png") or item.endswith(".PNG"):
            ...
            cluster_path_contour = "/home/sarbajit/PycharmProjects/BeeHive/clusters_contour/"
            ...
            return row_cmt[0],row_cmt[len(col_cmt)-1],col_cmt[0],col_cmt[len(col_cmt) - 1], len(col_cmt), row_height, col_width




test_path = '/home/sarbajit/PyCharm_Scripts/test/green_pad_same_name_new/final_rotated2/'
test_path1 = "/home/sarbajit/PyCharm_Scripts/test/back_project_test/roi_day2/"
cluster_path = "/home/sarbajit/PycharmProjects/BeeHive/clusters/"
cluster_path_cropped = "/home/sarbajit/PycharmProjects/BeeHive/cropped_clusters_contour/"
cluster_path_cropped_full = "/home/sarbajit/PycharmProjects/BeeHive/full_cropped_clusters_contour/"
c1_ideal = 40
c2_ideal = 335
item_roi_dict_total = {}
key_list=[]
            ...
            for root, dirs, files in os.walk(test_path):
                for item in files:
                    if item.endswith(".png"):
                        ...
                        #print match
                        my_file = open('/home/sarbajit/PyCharm_Scripts/test/back_project_test/match.txt','a')
                        ...
                        if match > 0.15:
                                ...
                                for key2 in item_roi_dict_total[key1]:
                                    if item in key2:
                                        if item_roi_dict_total[key1][item]<match:
                                            ...
                                            if os.path.isfile('/home/sarbajit/PycharmProjects/BeeHive/clusters/'+key1+'/'+item):
                                                os.remove('/home/sarbajit/PycharmProjects/BeeHive/clusters/'+key1+'/'+item)
                            ...
                            if col_width < 175:
                                ...
                                sliding_window(item, r1, r2, row_height,roihist)
